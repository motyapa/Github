...
public class ArrayDictionary<K, V> implements IDictionary<K, V> {
    ...
    public Iterator<KVPair<K, V>> iterator() {
        return new ArrayDictionaryIterator<K, V>(this.pairs, index);
    }
    ...
    private static class ArrayDictionaryIterator<K, V> implements Iterator<KVPair<K, V>> {
        ...
        public ArrayDictionaryIterator(Pair<K, V>[] pairs, int index) {
            this.pairs = pairs;
            this.index = index;
        }
        ...
        public KVPair<K, V> next() {
            if (hasNext()) {
                KVPair<K, V> temp = new KVPair<K, V>(pairs[currIndex].key, pairs[currIndex].value);
